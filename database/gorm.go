...
func InitMysqlDatabase() {
	...
	_ = DB.AutoMigrate(&model.User{}, &model.Renter{}, &model.Category{}, &model.Bike{}, &model.Payment{}, &model.Order{}, &model.OrderDetail{}, &model.Review{}, &model.History{}, &model.Report{})
}
